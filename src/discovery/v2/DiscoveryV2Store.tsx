...
export default class DiscoveryV2Store {
  ...
  constructor(plus: boolean = false) {
    ...
    this.trendingFeed = new FeedStore(true)
      .setEndpoint(
        'https://us-central1-bjjfanatics.cloudfunctions.net/app/sites/bjj/videos?type=most-popular&limit=10',
      )
    ...
    this.allFeed
      .setEndpoint(
        'https://us-central1-bjjfanatics.cloudfunctions.net/app/sites/bjj/videos?type=daily-deals&limit=10',
      )
      .setInjectBoost(false)
      .setLimit(15);
    ...
    this.topFeed
      .setEndpoint(
        'https://us-central1-bjjfanatics.cloudfunctions.net/app/sites/bjj/videos?type=new-releases&limit=10',
      )
    ...
    this.supermindsFeed = new FeedStore()
      .setEndpoint(
        'https://us-central1-bjjfanatics.cloudfunctions.net/app/sites/bjj/videos?type=trending-now&limit=10',
      )
      .setInjectBoost(false)
      .setLimit(15);
  ...
  async loadTrends(plus?: boolean): Promise<void> {
    ...
    try {
      const params = plus ? {plus: 1, as_activities: 1} : {as_activities: 1};

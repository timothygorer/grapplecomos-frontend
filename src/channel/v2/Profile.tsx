 ...
 * Channel screen
 */
const Profile = observer((props: PropsType) => {
  // =====================| STATES & VARIABLES |=====================>
  ...
  console.log("Store.feedstore is ", store.feedStore)
  ...
  return (
    <ChannelContext.Provider value={channelContext}>
      ...
      <AnimatedBanner
        ...
        bannerSource={'https://dummyimage.com/480x480/fff/aaa'}
      />

      {/*<FeedList*/}
      {/*  testID={'Profile:FeedList'}*/}
      {/*  ref={feedRef}*/}
...
const withError = withErrorBoundaryScreen(Profile);

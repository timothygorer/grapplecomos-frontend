...
const MindsVideo = observer((props: PropsType) => {
  ...
  const [posterSource, setPosterSource] = useState({
    uri: 'https://mediacdn.cincopa.com/v2/1099353/6753!ZxjFAAAAAAgaqB/0/RubberGuardTheMeathookbyBrandonMccaghrenVolume1.mp4',
  });
  ...
  const onReadyForDisplay = React.useCallback(
    e => {
      ...
      if (!localStore.readyForDisplay && props.onReadyForDisplay) {

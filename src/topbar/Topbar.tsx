...
import {IconCircled, Spacer, IconButton, H2, Avatar} from '../common/ui';
...
// import TabChatPreModal, { ChatModalHandle } from '../channel/v2/tabs/TabChatPreModal';
...
export const Topbar = observer((props: PropsType) => {
  ...
  const handleChannelNav = () => {
    navigation.push('ProfileScreen', {entity: channel});
  };

  const avatar = 'https://dummyimage.com/24x24/fff/aaa';
      ...
      <View style={container}>
        <View style={styles.topbar}>
          <View style={styles.topbarLeft}>
            ...
            {title ? (
              ...
              <>
                ...
                />
                <View style={[styles.logoWrapper, styles.noMarginLeft]}>
          ...
          <View style={styles.topbarRight}>
            ...
            {/*  )}*/}
            {/*</Spacer>*/}
            <PressableScale onPress={() => navigation.navigate('Compose')}>

...
export default observer(function Comment({
  ...
  console.log('comment is ', comment, comment.votedUp);
  ...
  const reply = React.useCallback(() => {
    ...
    if (canReply && !can_reply) {
      return store.setShowInput(true, undefined, `@timothy`); // fixme tgorer hardcode
    }
  ...
  }, [canReply, can_reply, comment, navigation, store]);
  ...
  return (
    <View
      style={[
        styles.container,
        focused ? styles.focused : theme.bcolorPrimaryBorder,
      ]}>

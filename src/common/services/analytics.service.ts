...
export class AnalyticsService {
   ...
   * @returns { void }
   */
  public trackView(ref: string, contexts = []): void {
   ...
   * @returns { void }
   */
  public trackClick(ref: ClickRef, contexts = []): void {
   ...
   */
  public buildEntityContext(entity: ContextualizableEntity) {
    return {
      schema: 'iglu:com.minds/entity_context/jsonschema/1-0-0',
      data: {
   ...
   * @returns { EventContext } - built entity_context.
   */
  public buildClientMetaContext(metadata: Metadata) {
    return {
